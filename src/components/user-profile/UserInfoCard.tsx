...
export default function UserInfoCard() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("https://back-end-three-delta.vercel.app/api/users/update", {
        method: "PUT",
        headers: {
                ...
                <div className="mt-7">
                  ...
                  <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                    <div>
                      ...
                      <Input type="text" name="firstName" defaultValue={formData.firstName} onChange={handleChange} />
                    </div>

                    <div>
                      <Label>Last Name</Label>
                      <Input type="text" name="lastName" defaultValue={formData.lastName} onChange={handleChange} />
                    </div>
