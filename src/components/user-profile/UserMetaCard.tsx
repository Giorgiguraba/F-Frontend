...
export default function UserMetaCard() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // const response = await apiRequest("users/update-profile", "PUT", updatedUser)
      ...
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6 bg-gradient-to-br from-gray-900 to-gray-800">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 overflow-hidden border-2 border-emerald-400 rounded-full dark:border-emerald-500 ring-2 ring-emerald-300 dark:ring-emerald-700">
              <Image
                width={80}
                height={80}
            ...
            <div className="order-3 xl:order-2">
              <h4 className="mb-2 text-lg font-semibold text-center text-white xl:text-left">
                {fullName}
                <span className="ml-2 inline-flex items-center px-2 py-1 text-xs font-medium rounded-full bg-emerald-900/50 text-emerald-400">
                  <svg className="w-3 h-3 mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 18.047m5.908 1.042-.347 1.97m1.563-8.864c4.924.869 6.14-6.025 1.215-6.893m-1.215 6.893-3.94-.694m5.155-6.2L12.26 4.145"
                      stroke="currentColor"
                      strokeWidth="1.5"
                      strokeLinecap="round"
              ...
              <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                <p className="text-sm text-gray-400">{formData.bio}</p>
            ...
            <div className="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
              <a
                ...
                className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-700 bg-gray-800 text-sm font-medium text-gray-400 hover:bg-gray-700 hover:text-white"
              >
                <svg
        ...
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-gray-900 p-4 lg:p-11">
          <div className="px-2 pr-14">
            ...
            <p className="mb-6 text-sm text-gray-400 lg:mb-7">
              Update your details to keep your crypto profile up-to-date.
            </p>
          </div>
          <form className="flex flex-col" onSubmit={handleSave}>
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              <div>
                <h5 className="mb-5 text-lg font-medium text-white lg:mb-6 flex items-center">
